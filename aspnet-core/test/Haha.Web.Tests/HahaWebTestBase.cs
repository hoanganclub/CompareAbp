...
{
    public abstract class HahaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HahaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HahaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HahaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HahaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HahaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HahaDbContext, Task<T>> func)
        {
            T result;
