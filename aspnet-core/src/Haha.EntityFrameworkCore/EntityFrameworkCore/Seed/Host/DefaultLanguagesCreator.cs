...
namespace Haha.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HahaDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HahaConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HahaDbContext context)
        {
            _context = context;
        }
